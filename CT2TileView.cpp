...
void CT2TileView::SetBits()
{
	...
	BYTE* pBmpTile = ((BYTE*)m_pPaintPanel)+ // ɨ����
		(m_biPaintPanel.biHeight-1)*(nScanLineSize*4); // ��
	...
	while(nTileNO<nTileCount)//TileView��Tileѭ��
	{
		switch(m_nDrawMode)
		{
		case CT2_DM_MAP:
		...
		nTilePixelNO=0;
		while(nTilePixelNO<nTilePixelCount)//Tile������ѭ��
		{
...
void CT2TileView::OnUpdateData()
{
	...
	if(m_nDrawMode)
	{
		...
		if(m_nWidth*m_nHeight<128)// ����8x16��16x8
