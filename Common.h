...
struct FAVORITES{
	TCHAR Doc[_MAX_PATH];		// �ĵ���
	TCHAR Desc[CT2_FAVLEN];		// ��ǩע��
	UINT nOffset;				// ƫ��
	WORD nCurView;				// ��ǰ��ͼ
	RGBQUAD pPal[256];			// ��ɫ��

	// TileView
	BYTE nTileFormat;			// ��ɫ��ʽ
	WORD nWidth;				// ����
	WORD nHeight;				// �߶�
	WORD nScale;				// ����
	BYTE nDrawMode:4;			// ����ģʽ
	BYTE nHCheck:1;				// ˮƽ��ת
	BYTE nVCheck:1;				// ��ֱ��ת
	BYTE nL90Check:1;			// ��ת��ʮ��
	BYTE nR90Check:1;			// ��ת��ʮ��
	BYTE n24Check;				// 2/4���Tile
	BYTE nSkipSize;				// �����ֽ�
	BYTE nPalIndex;				// ��ɫ���
	WORD nColCount;				// Tile��ͼ����
	WORD nLineCount;			// Tile��ͼ����
	UINT nMoOffset;				// Map/Oam��ַ
	WORD nBkPixType;			// ����
	BYTE nAutoColFit;			// ����Ӧ����
...
struct STATEDATA {
	...
	// Doc
	RGBQUAD pPal[256];			// ��ɫ��
	UINT nBlockOffset;			// ӳ���ƫ��
	BYTE nStateMapFile;			// �ĵ���ģʽ
	WORD nTblCodePage;			// ��������ʽ
	WORD nScriptCodePage;		// �����ű��ı����ʽ
	// SHUQIAN Sq[10];				// 10����ǩ
	TCHAR szPathName[3][_MAX_PATH];	// ���ļ����ĵ�

	// ChidFrm
	MAINFRMPOS wpChildFrm;		// �ĵ����λ��
	WORD nCurView;				// ��ǰ��ͼ

	// CT2View

	// TileView
	UINT nTileViewOffset;		// ƫ��
	BYTE nTileFormat;			// ��ɫ��ʽ
	WORD nWidth;				// ����
	WORD nHeight;				// �߶�
	WORD nScale;				// ����
...
struct GBAHEADER
{
	...
	char	GameTitle[12];		// ��д
	char	GameCode[4];		// ��д AGB-XXXX
	char	MakerCode[2];		// ��д "01"=Nintendo.
...
struct NDSSDAT
{
	...
	BYTE unknown2;			// 0x00
	BYTE unknown3;			// 0x01
	UINT nSDATSize;			// .sdat�ļ���С
	WORD nSize;				// tagNDSSDAT�ṹ��С(0x40)
	WORD wChunkMax;			//
	UINT nSymbPos;			// 0x40 tagSDATSYMB
	UINT nSymbSize;			// tagSDATSYMB�ṹʵ�ʴ�С
	UINT nSDatInfoPos;		// tagSDATINFO
	UINT nSDatInfoSize;		// tagSDATINFO�ṹ��С
	UINT nSDatFatPos;		// tagSDATFAT
	UINT nSDatFatSize;		// tagSDATFAT�ṹ��С
	UINT nSDatFileInfoPos;	// tagSDATFILEINFO
	UINT nRecSize;			// ȥ���ļ�ͷ�ṹ���ļ���С nSDATSize-nSDatFileInfoPos
...
struct SDATFILEINFO
{
	...
	UINT nSoundFileSize;	// ȥ���ļ�ͷ�ṹ���ļ���С tagSDAT.nSDATSize-tagSDAT.nSDatFileInfoPos
	UINT nSoundCount;		// ��Ŀ����
	UINT unknown;			// zero ?
};
// _FILE
...
struct NDSFILEHEADER
{
	...
	WORD nSize2;			// ��unknown2����
};

struct SUBHEADER
{
	char falgs[4];			// 'H' 'E' 'A' 'D' / Other...
	UINT nSize;				// SUBHEADER�ṹ��С
	// data... ?
};
...
struct NDSCMAP
{
	char flags[4];
	UINT nSize;
	WORD nBeginCode;	// ��ʼ����(0000)
	WORD nEndCode;		// ��������(FFFF)
	WORD nType;			// =1 wChar��Ч =0 nOffset��wChar��Ч ? =2 isTbl
	WORD unknown;		// zero?
	UINT nOffset;		// ?
	WORD wCount;
	struct
...
struct PACFILE_FNT
{
	BYTE	nFNTCount;	// nIndex*0x200 ÿ��FAT��0x200�ֽ�
	BYTE	nFileNameLen;
	BYTE	nUnknown2;
	char	FileName[1];
};
...
#define CP_SHIFTJIS				932		// ANSI/OEM	���� Shift-JIS
#define CP_HZGB2312				52936	// HZ-GB2312��������
#define CP_GB18030				54936	// GB18030	��������
#define CP_GBK					936		// ANSI/OEM	�������� GBK
#define CP_BIG5					950		// ANSI/OEM	�������� GBK
...
//���uFlages=SHGFI_SMALLICON|SHGFI_LARGEICON��ͼ�꽫��С/��ͼ�ꡣ
BOOL LoadSystemImageList(HIMAGELIST& hImages, UINT uFlags = SHGFI_SMALLICON);

//���uFlages=SHGFI_OPENICON|SHGFI_SMALLICON|SHGFI_LARGEICON��Ŀ¼ͼ�꽫�Ǵ򿪵ġ�С/��ͼ�ꡣ
